...
const Overview = () => {
  // --- Carousel State & Logic (Exact copy from Section3) ---
  ...
  // --- Animation Variants (Exact copy from Section3) ---
  ...
  return (
    <div className="w-full max-w-[100vw] flex flex-col items-center animate-fadeIn overflow-x-hidden">
      ...
      {/* 3. Bottom Section */}
      <div 
        className="w-full flex flex-col items-center justify-center max-w-[1380px] px-4 md:px-0"
      ...
      >
        ...
        {/* Day 1 Block */}
        <div className="w-full flex flex-col md:flex-row items-center justify-between gap-10 md:gap-[80px] mb-[200px]">
           {/* Left Image */}
           <div className="shrink-0 w-full md:w-[810px] h-auto md:h-[489px] relative rounded-[24px] overflow-hidden">
             {/* UPDATED: Replaced img with Next.js Image */}
             <Image 
