...
export default function Header() {
  ...
  // State for "Coming Soon" button text
            ...
            {navLinks.map((link) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Dropdown - NOW WITH SOLID BACKGROUND */}
                  <AnimatePresence>
                    {link.subLinks && hoveredLink === link.name && (
                      ...
                      >
                        <div className="
                          ...
                          pt-2 px-3 pb-3 self-stretch 
                          rounded-b-[16px] rounded-t-none min-w-[220px] 
                          ...
                          {link.subLinks.map((subLink, idx) => (
                            ...
                            >
                                <Link
                                  href={subLink.href}
                                  className={`
                                    whitespace-nowrap text-sm w-full text-center py-2 rounded-md transition-all duration-200 font-['Manrope',_sans-serif] block
                                    ${pathname === subLink.href.split('#')[0] 
                                    ? "text-white bg-white/5 font-medium" 
                                    : "text-[#E6E6E6]/80 hover:text-white hover:bg-white/5"
                                    }
                                  `}
                                >
                                  {subLink.name}
            ...
            >
              ...
              <div 
                className="
                  ...
                  bg-[#CE921B] px-6 py-2.5 
                  text-[14px] font-bold text-white uppercase tracking-wider 
                  shadow-lg shadow-[#CE921B]/20 
                  hover:bg-[#B88218] transition-all
...
// ... (Rest of the Sub-components remain unchanged)
