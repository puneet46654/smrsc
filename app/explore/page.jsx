...
const ExplorePage = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#020617]">
      ...
      {/* Changed main wrapper to allow the image margins to control spacing */}
      <main className="flex-grow w-full flex flex-col items-center overflow-x-hidden">
        
        {/* === 1. HERO IMAGE SECTION (Updated to match Section1 properties) === */}
        <section className="w-full bg-transparent flex justify-center">
          ...
          >
            <div
              style={{
                ...
                marginRight: "114px",
                width: "100%",
                maxWidth: "1723px",       // Matches your reference
                aspectRatio: "1723 / 876", // Matches your reference
              }}
              className="relative"
            >
              {/* UPDATED: Changed .png to .webp */}
              <Image
          ...
          {/* --- MOBILE FALLBACK --- */}
          {/* Adjusted margin top to account for fixed header on mobile */}
          <div className="md:hidden w-full relative aspect-[1723/876] mt-[100px] px-4 mb-10">
             {/* UPDATED: Changed .png to .webp */}
             <Image
                src="/images/explore/hero.webp"
                alt="Explore Hero"
